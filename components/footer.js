...
export default function Footer(props) {
  return (
    <footer>
      ...
      <p className="smaller">I made a react powered bingoCard&nbsp;generator, inspired by our new work/life of video conferencing. <em>It&rsquo;s a work in progress</em></p>
